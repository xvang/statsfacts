"""
Django settings for statfacts project.
...
#SECRET_KEY = '(8bd&y%hc*%k@h&ga^2=b7csmi+q3x+=c0if(pgfrwooq1$xtd'
SECRET_KEY = config.get("secretkey", "secret")
...
WSGI_APPLICATION = 'statfacts.wsgi.application'
